/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/SDK8.5/SDK/MEDIA/HLSL/post_frostFast.fx#1 $
...
vertexOutput VS_Quad(float3 Position : POSITION, 
			float3 TexCoord : TEXCOORD0)
{
    vertexOutput OUT = (vertexOutput)0;
    OUT.HPosition = float4(Position, 1);
    OUT.UV = TexCoord.xy; 
    return OUT;
}
...
float4 frostedPS(vertexOutput IN) : COLOR {
...
technique Main 
{
    ...
    {		
		...
		ZWriteEnable = false;
		CullMode = None;
		PixelShader = compile ps_2_0 frostedPS();
    }
}
