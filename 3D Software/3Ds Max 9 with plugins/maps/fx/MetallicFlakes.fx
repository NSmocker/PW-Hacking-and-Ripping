...
float4 k_a <
	string UIName = "Metal Ambient";
> = float4( 0.2f, 0.2f, 0.2f, 1.0f );    // ambient  (metal)

float4 k_d <
	string UIName = "Metal Diffuse";
> = float4( 0.1f, 0.1f, 0.5f, 1.0f );    // diffuse  (metal)

float4 k_s <
	string UIName = "Metal Specular";
> = float4( 0.4f, 0.3f, 0.1f, 1.0f );    // specular (metal)

float4 k_r <
	string UIName = "Wax Specular";
> = float4( 0.7f, 0.7f, 0.7f, 1.0f );    // specular (wax)
