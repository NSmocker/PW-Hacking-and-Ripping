...
technique Shaded_Unilluminated
{
	...
	ZWriteEnable = true;
        ...
        VertexShader = compile vs_1_1 VS(true,false);
	PixelShader = NULL;
    }  
}
...
technique Shaded_Illuminated
{
	...
	ZWriteEnable = true;
        ...
        VertexShader = compile vs_1_1 VS(true,true);
	PixelShader = NULL;
    }  
}
...
technique Unshaded_Illuminated
{
	...
	ZWriteEnable = true;
        ...
        VertexShader = compile vs_1_1 VS(false,true);
	PixelShader = NULL;
    }  
}
...
technique Unshaded_Unilluminated
{
	...
	ZWriteEnable = true;
        ...
        VertexShader = compile vs_1_1 VS(false,false);
	PixelShader = NULL;
    }  
}