// 3ds max effect file
// Wood Shader - updated to support 3ds max auto ui
...
float4 k_a  <string UIName = "Ambient";> = float4( 0.2f, 0.2f, 0.2f, 1.0f );    // ambient
float4 k_d  <string UIName = "Diffuse";> = float4( 1.0f, 0.7f, 0.2f, 1.0f );    // diffuse
float4 k_s  <string UIName = "Specular";> = float4( 1.0f, 1.0f, 1.0f, 1.0f);    // diffuse    // specular
int    n   : MATERIALPOWER = 20;                            // power
...
#define RINGSCALE   7.0f
#define POINTSCALE  0.08f
#define TURBULENCE  4.0f
