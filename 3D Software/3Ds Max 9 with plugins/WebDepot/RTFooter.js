...
document.writeln(xmsgVersionBlock);
document.writeln('</td></tr>');

//	Make sure xmsgCountryPrivacyPolicyURL is set correctly
SetCountryParms();

//	Change Privacy Policy URL in RTConnectLive.html if there is no Internet connection
if ((document.title == xmsgRTConnect) &&
	(internetconnection == "n")) {
	xmsgCountryPrivacyPolicyURL = userTempPath + xmsgCountryPrivacyPolicyURL;
}

//	Privacy Block
document.writeln('<tr><td valign="top" align="center">');
document.writeln('<a href="'+xmsgCountryPrivacyPolicyURL+'" target=_blank><font size=1>'+xmsgPrivacyPolicy+'</font></a>');
document.writeln('</td></tr>');
...
// SIG // AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEJvu
// SIG // 9UKp2h9ziJIZxE5qFvaggg+yMIIDpjCCAw+gAwIBAgIQ
...
// SIG // CQQxEgQQqVi8BFIrgvB9XeD9iR2hKzBUBgorBgEEAYI3
// SIG // AgEMMUYwRKAmgCQAQQB1AHQAbwBkAGUAcwBrACAAQwBv
// SIG // AG0AcABvAG4AZQBuAHShGoAYaHR0cDovL3d3dy5hdXRv
// SIG // ZGVzay5jb20gMA0GCSqGSIb3DQEBAQUABIGAlUzR3Ja5
// SIG // TeI/LhGoSMJjJ/FYaZDcW3ev2eQPEWaRGoFU19VaeiCc
// SIG // m96sWEV/i1Cwb+MR6dtXEUNPgtxjbp3s3it1SqhSM8tN
// SIG // DK0vHCI+xkcoHSg3M/KUo6wbWUV0UOlBYhKoMnT/bHhP
// SIG // uLdOA/4JOMqSWUCTliLWbMRrPCnmu32hggH/MIIB+wYJ
...
// SIG // BwEwHAYJKoZIhvcNAQkFMQ8XDTA0MTEyMTA1NDcyNVow
// SIG // HwYJKoZIhvcNAQkEMRIEEAF7Olyw3s678KCfBh0t8A0w
// SIG // DQYJKoZIhvcNAQEBBQAEggEAAy/9Ot1aE3xH3rs25M+C
// SIG // Dqd7YRvLpZpj5/30skG6Ytj52dzEoN87b76vGGBqICMd
// SIG // M5s7nGej6f03ZgXKXM+/9i+in2nNEdFk5KTDPRvz0lSF
// SIG // D5urwsfWXcq2bbuPFOYdsUUwqy25BB0HLwVOEwzZ71zL
// SIG // uV2J+J7gHWE1IyElR3Bl1666oRXAIMj+y1FVCSAadwAb
// SIG // Dx5CB/9VBAheS71kuue9GAK+byWf3fVH9ZiNWdMbUGgP
// SIG // HaLmbDv/W1+XPSksHV6w99P0Yrrkzu2IJPnXyNJl9nPD
// SIG // N05JR936aP8UTLHIF9IYadaka8AhhEyilbWS/NwMforB
// SIG // +7ce+qOCSeNePQ==
