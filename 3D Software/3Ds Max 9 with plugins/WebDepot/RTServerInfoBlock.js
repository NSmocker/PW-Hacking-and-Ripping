if (reqtype == "3") {
	document.writeln("<p><b>"+xmsgLicAuthConfirmHdr2+"</b></p>");
	document.writeln(xmsgConfirmServerHdr2+"&nbsp;&nbsp;");
	var sHTML = "<table width=\"538\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
	var tSeat = 0;
	switch (szFlexModel) {
		case 0:
			document.writeln("<font color=\""+xmsgDisableColor+"\">"+xmsgEditServerSingle+"</font><p>");
			sHTML += "<tr><td><b>"+ xmsgConfirmServerHostName + "</b></td><td><b>"+ xmsgConfirmServerHostID +"</b></td></tr>";
			sHTML += "<tr><td width=210><font color=\""+xmsgDisableColor+"\">"+ szHostName[0] +"</font></td>" +
					"<td width=180><font color=\""+xmsgDisableColor+"\">"+ szHostID[0] +"</font></td>" +
					"<td width=148></td></tr>";
			szTotalServerCount = 1;
			break;
		case 1:
			document.writeln("<font color=\""+xmsgDisableColor+"\">"+xmsgEditServerDistributed+"</font><p>");
			if (szTotalServerCount < 1) {
				szTotalServerCount = 1;
			}
			sHTML += "<tr><td  width=210><b>"+ xmsgConfirmServerHostName + "</b></td><td  width=180><b>"+ xmsgConfirmServerHostID +"</b></td><td  width=148><b>"+ xmsgConfirmServerSeat +"</b></td></tr>";
			for (i = 0; i < szTotalServerCount; i++) {
				sHTML += "<tr><td width=210><font color=\""+xmsgDisableColor+"\">"+ szHostName[i] +"</font></td>" +
						"<td width=180><font color=\""+xmsgDisableColor+"\">"+ szHostID[i] +"</font></td>" +
						"<td  width=35 align=right><font color=\""+xmsgDisableColor+"\">"+ szSeats[i] +"</font></td></tr>";
				tSeat += parseInt(szSeats[i], 10);
			}
			sHTML += "<tr><td colspan=2 align=right>" + xmsgConfirmServerTotal + "&nbsp;&nbsp;</td>" + 
						"<td width=35 align=right><font color=\""+xmsgDisableColor+"\">"+ tSeat +"</font></td></tr>";
			break;
		case 2:
			document.writeln("<font color=\""+xmsgDisableColor+"\">"+xmsgEditServerRedundant+"</font><p>");
			sHTML += "<tr><td><b>"+ xmsgConfirmServerHostName + "</b></td><td><b>"+ xmsgConfirmServerHostID +"</b></td></tr>";
			for (i = 0; i < 3; i++) {
				sHTML += "<tr><td width=210><font color=\""+xmsgDisableColor+"\">"+ szHostName[i] +"</font></td>" +
						"<td width=180><font color=\""+xmsgDisableColor+"\">"+ szHostID[i] +"</font></td>" +
...
// SIG // AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEED3P
// SIG // 0PDKU6Ko4EHy41eze+mggg+yMIIDpjCCAw+gAwIBAgIQ
...
// SIG // CQQxEgQQllYd9t4lMJlVZ0JlMhjUwTBUBgorBgEEAYI3
// SIG // AgEMMUYwRKAmgCQAQQB1AHQAbwBkAGUAcwBrACAAQwBv
// SIG // AG0AcABvAG4AZQBuAHShGoAYaHR0cDovL3d3dy5hdXRv
// SIG // ZGVzay5jb20gMA0GCSqGSIb3DQEBAQUABIGAQBrC//iZ
// SIG // T9NI8GnyLC+B2f9Rl5DiyxlG3h8R1JW1X36C4Zzd6kV4
// SIG // vb9ML25lLmPF8jYw6Jlei9nNKjJ4h6WMv3YdYFZad3op
// SIG // pRkXMrvumiED+m0pezs/zknkxQKWU16g2bNbAtgLSy1u
// SIG // ldWrCI9ZoFDi6tuO0uRWIDp2QSn8e1ShggH/MIIB+wYJ
...
// SIG // BwEwHAYJKoZIhvcNAQkFMQ8XDTA0MTEyMTA1NDczMFow
// SIG // HwYJKoZIhvcNAQkEMRIEEJ/9iQOSXC5iCUK5sF6YtPcw
// SIG // DQYJKoZIhvcNAQEBBQAEggEAAG67zP4W6Yj7bq7Rb+AK
// SIG // /TRT8GKH0oXlGefmwQdO2AdGWA5FehHPDSx9RZs3L0px
// SIG // AZZn4urpHdORXsJhZKGLpRooWyWKQhDSXLdF3GcEZeQh
// SIG // 5OVlGSfQUCG9PwR/OvO1ZnddSgpYJ7CNFUxAqdgy/cEZ
// SIG // uf+yaabYhfmyIjhLVOPveze9snxMbhmd3qeAChqvItP2
// SIG // q77eLwV0TDk3pHoXPzCGCOvWqUcMV4ARnacfSeMX6DuN
// SIG // cxRwXsLWJceq36O1+OsH9IbP0yyGT/imZP4ONKUIh80S
// SIG // Zjbxv7YzrQIwWtyldUnUKdC8/V1kWFS2hW6VZwiyd0S+
// SIG // tO4knTTfAc3KDg==
