//	Print out Software Information section
document.writeln('<table border="0" cellpadding="0" cellspacing="1">');
document.writeln('<tr><td></td></tr>');
document.writeln(ProductConfirm);
if (sernum != "") {
	document.writeln(sernumConfirm);
}
if (upgrade == "y" && osernum != "") document.writeln(OSNGrey);
if (req != "") document.writeln(RC);
...
// SIG // AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEHXZ
// SIG // w6bSPwb/AwchK5IPkC6ggg+yMIIDpjCCAw+gAwIBAgIQ
...
// SIG // CQQxEgQQp/CAtOcBABYsyc6S/cJxPTBUBgorBgEEAYI3
// SIG // AgEMMUYwRKAmgCQAQQB1AHQAbwBkAGUAcwBrACAAQwBv
// SIG // AG0AcABvAG4AZQBuAHShGoAYaHR0cDovL3d3dy5hdXRv
// SIG // ZGVzay5jb20gMA0GCSqGSIb3DQEBAQUABIGAfq/mK8wM
// SIG // l10a5d89CoukOfF1/TZooRRoc05unUKaFbattoxAE4vF
// SIG // vU0cQV1xZ272+1Tgc6Ng5addUZ0G+e+HnTfdGZDEeiQn
// SIG // F1FSqQGScwW9Mr8MKvDNuCEhApaaf1t+2OqioW+ItkGF
// SIG // 3F1fOW8FIUIJaifOC1Xgpfh3dlMHhY+hggH/MIIB+wYJ
...
// SIG // BwEwHAYJKoZIhvcNAQkFMQ8XDTA0MTEyMTA1NDczMVow
// SIG // HwYJKoZIhvcNAQkEMRIEEPTfo5LjYtX4rrzkmKhUNHgw
// SIG // DQYJKoZIhvcNAQEBBQAEggEAjLghq+EsshmU3IMAIFJq
// SIG // nZl7Gt/YI0LgAy0/EVbqA/kN1hFAwZp/E5KNS4Av34vL
// SIG // lFNTc3XtYezy7+5e4oqLx6aKfBbmZ6//yMrbl8ZGG8WA
// SIG // EXVp5EFKDGJKH6wZBlpUh7V25mebw59vtr8cqHPIKucc
// SIG // btddg0cfTJaklXDMA+Gp9P1jiVh1Z0g2WfCF/T6tEo3T
// SIG // 2bMrisprsVa5Ymuoa5kRnan4y2NMO1Ksc3sjtm9ypwQ+
// SIG // hcstv1FIv+BFNW4ehlTVKW/KElOjyZlJDXJrdLzqGm0t
// SIG // hHknEuAmA1C7M/OotIVYSDpJJf7OiTvaPtYM2BQxWuWt
// SIG // W1xjxKn8W4/82g==
