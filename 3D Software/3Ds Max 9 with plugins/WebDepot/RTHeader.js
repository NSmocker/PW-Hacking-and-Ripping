//	print out the header of each Register Today HTML page

//	The graphic and logo section
document.writeln('<table border=0 cellpadding=0 cellspacing = 0>');
document.writeln('<tr>');
document.writeln('<td><h4>&nbsp;&nbsp;');
if (reqtype == 3) {
	document.writeln(xmsgRegTitleNSA);
} else {
	if (rtbuymode == "y") {
		document.writeln(xmsgRegTitleBuy);
	} else {
		document.writeln(xmsgRegTitle);
	}
}
document.writeln('</h4>');
document.writeln('</td>');
document.writeln('<td valign="top" align="right"><img src="'+iconlocation+'adsk_logo.gif"></td>');
document.writeln('</tr>');
document.writeln('<tr>');
document.writeln('<td colspan="2"><img src="'+iconlocation+'image_band.jpg"></td>');
document.writeln('</tr>');
document.writeln('</table>');

//	Starting of the page - 
//	and starting of the Navigation bar
document.writeln('<table>');
document.writeln('<tr>');
document.writeln('<td bgcolor="'+xmsgNavigationBGColor+'" width="180" valign="top">');
...
// SIG // AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEPx9
// SIG // VnZegEUFQ6zDGPg8dniggg+yMIIDpjCCAw+gAwIBAgIQ
...
// SIG // CQQxEgQQO3IF+q+Jn/wf8Cq2Hs+8+DBUBgorBgEEAYI3
// SIG // AgEMMUYwRKAmgCQAQQB1AHQAbwBkAGUAcwBrACAAQwBv
// SIG // AG0AcABvAG4AZQBuAHShGoAYaHR0cDovL3d3dy5hdXRv
// SIG // ZGVzay5jb20gMA0GCSqGSIb3DQEBAQUABIGALbsg7u9x
// SIG // ymI+O90jNKf6ZWs6moew4sm7ppI8PdOUEgUgcSvILBOm
// SIG // w7qJIIEw52gOIKszd0Q7EQZkDFnFK50fdSTJ7su+WG2O
// SIG // zF0pwx1XDYnm10rPhOv+RJj3p3StiXL7gBvU9cfHdyp2
// SIG // pcN9dmcpZYH9vjSk4EJS6SGwrYN5FtWhggH/MIIB+wYJ
...
// SIG // BwEwHAYJKoZIhvcNAQkFMQ8XDTA0MTEyMTA1NDcyNlow
// SIG // HwYJKoZIhvcNAQkEMRIEEGPetNH+pBWNIbPVu8RZioow
// SIG // DQYJKoZIhvcNAQEBBQAEggEAVAYrhWeX3NYKX8doAUm2
// SIG // 9qGUApQRYWBlpiPzOOWK6NJXkP2mUO8RH7LAAef7tqdu
// SIG // /3Dggn3sapKwqRkzwUONJWZ0QaQOI7SgXPVY3q6u8VeW
// SIG // nbnEb3SjYqP5cIZSeCde4pep/sl2XNwpoerSyJcSQ/vN
// SIG // jWfRQ8W76ZvHNGvKbxDMdDGPxtq0HdU6ONFu3Iwr9JHz
// SIG // fzGDRZA+IEIvVxImJJeQ/VLaNqP7+vFSVAg9IPRZlGEP
// SIG // NibDDnZ5vcWcw4IgBw+vFwRNlIwsoOPOQKKroUk9ylMB
// SIG // SrsVxGJrvpsWGb/VVE5t/bGqe9T+a6al1tW3HkT78mlS
// SIG // gBENwP6BQUq8Mg==
